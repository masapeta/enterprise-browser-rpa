...
class OpenAICompatibleProvider(LLMProvider):
    """Handles OpenAI, Grok, and other compatible APIs"""
    def __init__(self):
        ...
        self.client = AsyncOpenAI(
            ...
            base_url=settings.LLM_BASE_URL # Optional, needed for Grok or local models
        )
...
def get_llm_provider():
    ...
    # Default covers "openai", "grok", and others compatible
